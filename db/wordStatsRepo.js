...
// data - nobody can distinguish a 10-minute-old word cloud from a live one. See lib/queryCache.js
// for the mechanics (shared with statsRepo.js/userStatsRepo.js) and config/statsLimits.js for
// where the TTL/size numbers come from.
// ---------------------------------------------------------------------------------------
const { cached: withCache, _store: cache } = createCache({
