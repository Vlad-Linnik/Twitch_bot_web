...
// bot is the LOWEST available memory in an hour, not the average, because a shortage deep enough to
// outrun whatever swap the host has is resolved by the kernel terminating a process outright, and
// an average hides exactly the momentary dip that does it. So each hourly bucket
