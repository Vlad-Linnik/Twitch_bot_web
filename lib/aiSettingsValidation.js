...
//
// ПОТОЛОК ОБЯЗАН БЫТЬ ЗАМЕТНО БОЛЬШЕ ВСТРОЕННОГО ТЕКСТА, и это не запас на будущее, а условие
// правильности. На сравнении со встроенным текстом держится «пустота - это подписка на код»
// (parseGlobalConfig ниже): текст, совпавший дословно, хранится как пустой. Если встроенный текст
// не влезает в потолок, форма присылает его обрезанным, сравнение не совпадает никогда, и
// администратор, открывший форму и нажавший «Сохранить», молча отписывает канал от кода - да ещё
// и обрезанными правилами. SYSTEM_RULES растут с каждым новым разделом, так что запас нужен.
