...
// units/sec. Keep this close to the ball's fastest vertical component -
// MAX_BALL_SPEED * sin(MAX_BOUNCE_ANGLE) = 500 * sin(60 deg) ~= 433 - so the
// paddle can still chase a steeply-angled ball late in a match, once the
// per-point ramp has run. At the old 300 it couldn't, which reads as broken
// controls rather than as difficulty; 420 leaves only the single most extreme
// bounce (edge hit at the speed cap) genuinely un-chaseable.
